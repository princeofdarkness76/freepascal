...
set APPENGINE_API_JAR="%GCD_DIR%.appengine\lib\impl\appengine-api.jar"
...
if NOT EXIST %APPENGINE_API_JAR% (
...
java -cp %DATASTORE_JAR%;%APPENGINE_API_JAR%;%APPENGINE_TOOLS_JAR%;%APPENGINE_API_STUBS_JAR% ^
